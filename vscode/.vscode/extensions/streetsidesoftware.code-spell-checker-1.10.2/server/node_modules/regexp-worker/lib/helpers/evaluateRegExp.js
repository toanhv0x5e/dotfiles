...
function execRegExp(regExp, text) {
    const { elapsedTimeMs, r: matches } = timer_1.measureExecution(() => _execRegExp(regExp, text));
    return { elapsedTimeMs, matches };
}
exports.execRegExp = execRegExp;
function execRegExpMatrix(regExpArray, textArray) {
    const { elapsedTimeMs, r: matrix } = timer_1.measureExecution(() => {
...
function execRegExpArray(regExpArray, text) {
    const { elapsedTimeMs, r: results } = timer_1.measureExecution(() => {
