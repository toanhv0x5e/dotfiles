...
exports.isErrorResponse = exports.createErrorResponse = exports.responseTypeError = exports.createResponse = exports.createRequest = exports.isResponse = exports.genIsResponse = exports.isRequest = exports.genIsRequest = void 0;
...
function isRequest(v) {
    return !!(typeof v === 'object' && typeof v.requestType === 'string' && uniqueId_1.isId(v.id));
}
...
function isResponse(v) {
    return !!(typeof v === 'object' && typeof v.responseType === 'string' && uniqueId_1.isId(v.id));
}
exports.isResponse = isResponse;
function createRequest(requestType, data) {
    return { id: uniqueId_1.createId(), requestType, data };
}
