...
class Scheduler {
    ...
    scheduleRequest(request, timeLimitMs = this.executionTimeLimitMs) {
        ...
        if (!procedure_1.isRequest(request)) {
    ...
    terminateRequest(requestId, message = 'Request Terminated') {
        ...
        const elapsedTime = (request === null || request === void 0 ? void 0 : request.startTime) ? timer_1.elapsedTimeMsFrom(request.startTime) : 0;
        // istanbul ignore else
    ...
    static createRequest(requestType, data) {
        return procedure_1.createRequest(requestType, data);
    }
    get worker() {
        if (!this._worker) {
            this._worker = worker_1.createWorker();
...
function checkResponse(response, data) {
    if (procedure_1.isErrorResponse(response)) {
