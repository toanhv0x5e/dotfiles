...
exports.MatchRegExpArrayResult = exports.MatchRegExpResult = exports.execRegExpMatrixOnWorker = exports.execRegExpOnWorker = exports.RegExpWorker = void 0;
...
class RegExpWorker {
    ...
    execRegExp(regExp, text, timeLimitMs) {
        const req = Procedures_1.createRequestExecRegExp({ regexp: regExp, text });
        return this.makeRequest(req, timeLimitMs);
    }
    execRegExpMatrix(regExpArray, textArray, timeLimitMs) {
        const req = Procedures_1.createRequestExecRegExpMatrix({ regExpArray, textArray });
        return this.makeRequest(req, timeLimitMs);
    }
    matchRegExp(text, regExp, timeLimitMs) {
        const req = procMatchRegExp_1.createRequestMatchRegExp({ regexp: regExp, text });
        return this.makeRequest(req, timeLimitMs)
            .then(MatchRegExpResult.create);
    }
    matchRegExpArray(text, regExp, timeLimitMs) {
        const req = procMatchRegExpArray_1.createRequestMatchRegExpArray({ regexps: regExp, text });
...
class MatchRegExpResult {
     ...
     */
    get ranges() {
        return evaluateRegExp_1.flatRangesToRanges(this.raw_ranges);
    }
    static create(res) {
